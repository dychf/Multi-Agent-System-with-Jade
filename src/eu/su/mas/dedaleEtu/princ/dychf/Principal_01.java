package eu.su.mas.dedaleEtu.princ.dychf;
...
import eu.su.mas.dedaleEtu.mas.agents.dychf.MyFirstAgent;
...
public class Principal_01 {
    ...
    private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
        ...
        /*****************************************************
         *
         * FIXME: ADD YOUR AGENTS HERE - As many as you want.
        ...
        agentName = "dychf_gogogo";

        //3) If you want to give specific parameters to your agent, add them here
        Object[] entityParameters1 = {"My parameters"};

        //4) Give the class name of your agent to let the system instantiate it
        ag = createNewDedaleAgent(c, agentName, MyFirstAgent.class.getName(), entityParameters1);
        agentList.add(ag);
