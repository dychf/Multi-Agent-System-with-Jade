...
import eu.su.mas.dedaleEtu.mas.behaviours.ReceiveDoneFlag;
...
public class ExploreAgent extends AbstractDedaleAgent implements AgentInterface {
    ...
    private static final String receiveDoneFlag = "receiveCollect";
    ...
    protected void setup() {
        ...
        fsm.registerState(new ReceiveDoneFlag(this), receiveDoneFlag);
        ...
        fsm.registerTransition(goToNode, receiveDoneFlag, 3);

        fsm.registerDefaultTransition(receiveDoneFlag, receiveDoneFlag);

        fsm.registerTransition(receiveDoneFlag, goToTanker, 3);
